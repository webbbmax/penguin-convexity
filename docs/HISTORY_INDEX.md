...
| C2.5 X01 热修 | `docs/C2.5_X01_PROJECT_DETAIL_IDENTITY_HOTFIX_FINAL_ACCEPTANCE_20260818.md`、`docs/C2.5_X01_PROJECT_DETAIL_IDENTITY_HOTFIX_REVALIDATION_20260818.md`、`docs/C2.5_X01_PROJECT_DETAIL_IDENTITY_HOTFIX_RELEASE_20260818.md`、`docs/C2.5_X01_PROJECT_DETAIL_IDENTITY_HOTFIX_RELEASE_MANIFEST_20260818.json` | 项目卡片与详情 identity 一致性；保留原 NO-GO 与定点复验历史 |
