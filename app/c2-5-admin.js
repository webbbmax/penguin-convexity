(function c25ManagerControlPlane() {
  ...
  function ruleCounts(value) {
    ...
    return `输入 ${fmtValue(value.input, "0")} · 适用 ${fmtValue(value.applicable, "0")} · 基线通过 ${fmtValue(value.baselinePassed, "0")} · 当前通过 ${fmtValue(value.effectivePassed, "0")} · 变化 ${fmtValue(value.changed, "0")}`;
  }
